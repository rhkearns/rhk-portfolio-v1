...
const Contact = () => {
  return (
    <div className="contact-section">
      ...
      <div className="links">
        <a href="https://drive.google.com/file/d/1sZk5dnf_b8_w5R7l0NzjIpcjWWXmeA4m/view?usp=sharing" target='_blank' rel='noopener noreferrer'><img src={resume} alt='resume' id="resume-icon"/></a>
